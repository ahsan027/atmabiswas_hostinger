...
<script>
  ...
  gtag('config', 'G-EZVV9DWWY7');
    ...
    <title>Green Energy &amp; Solar Power Programs - ATMABISWAS Bangladesh</title>
    <?php include 'seo.php'; ?>
...
<body>
    ...
    <header>
        ...
        <p>ATMABISWAS promotes renewable energy solutions to reduce carbon footprints and ensure energy accessibility.
        </p>
    </header>
    <div class="content">
        <p>ATMABISWAS is actively working on two groundbreaking initiatives: <strong>Bondhu Chula</strong> and
            <strong>Souro Shokti</strong>. These projects aim to provide clean energy alternatives and promote
