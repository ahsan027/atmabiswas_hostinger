...
<body>
    ...
    <div class="container">
        ...
        <section class="profile-grid">
            <div class="profile">
                <img src="Photos/Akkas_PP.jpg" loading="lazy" alt="Akkas Ali">
                <h2>Akkas Ali</h2>
                <p>Assistant Director</p>
            </div>
            <div class="profile">
                <img src="Photos/Hasan_PP.jpg" loading="lazy" alt="MD. Hassanur Jamman">
                <h2>MD. Hassanur Jamman</h2>
                <p>Assistant Director</p>
            </div>
            <div class="profile">
                <img src="Photos/rimusir.jpg" loading="lazy" alt="Rimu Sir">
